            ...
            <div className="bg-white/5 rounded-xl p-6">
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <span className="text-green-400 ml-2 capitalize">{user.userType}</span>
                </div>
              </div>
            </div>
            
            <div className="bg-white/5 rounded-xl p-6">
              <h3 className="text-white font-semibold mb-4">Energy Projects</h3>
              <p className="text-white/70">Start optimizing your renewable energy projects!</p>
            </div>
          </div>
        </div>
      </div>
